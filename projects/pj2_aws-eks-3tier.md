...
<p>
  <a href="https://github.com/cloud-sue/petclinic_web">
    <img src="https://img.shields.io/badge/GitHub-WEB%20Repo-121011?style=for-the-badge&logo=github&logoColor=white">
  </a>
  <a href="https://github.com/cloud-sue/petclinic_pj_middle">
    <img src="https://img.shields.io/badge/GitHub-WAS%20Repo-121011?style=for-the-badge&logo=github&logoColor=white">
  </a>
</p>
...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <img src = "https://img.shields.io/badge/Kubernetes%201.35-326CE5?style=for-the-badge&logo=kubernetes&logoColor=white">
...
- **Docker Compose로 로컬 사전 검증**: EKS 배포 전 `docker-compose`로 WEB/WAS 컨테이너를 로컬에서 빌드·기동하고 RDS 연동·로그를 확인한 뒤 ECR 푸시 → 배포 단계로 진행 (Nginx+PHP-FPM은 Supervisor로 단일 컨테이너 내 동시 실행)
...
- Frontend(WEB) Repo: [cloud-sue/petclinic_web](https://github.com/cloud-sue/petclinic_web)
- Backend(WAS) Repo: [cloud-sue/petclinic_pj_middle](https://github.com/cloud-sue/petclinic_pj_middle)
