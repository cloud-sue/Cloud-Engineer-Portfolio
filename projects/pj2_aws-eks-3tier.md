...
PetClinic 애플리케이션을 **컨테이너 기반 3-Tier(WEB/WAS/DB)** 구조로 AWS EKS 위에 배포·운영한 개인 프로젝트입니다. <br> 멀티 스테이지 Dockerfile로 이미지를 경량화하고, ECR·Secret·Ingress를 활용해 실서비스에 가까운 컨테이너 운영 환경을 직접 구성했습니다.
